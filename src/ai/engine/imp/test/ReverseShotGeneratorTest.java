...
public class ReverseShotGeneratorTest {
	...
	public void testBallNotOnPath() {
		ReverseShotGenerator shotGen = new ReverseShotGenerator();
		assertTrue("The path is clear", shotGen.ballNotOnPath(new Vec2(1.0f,
				3.0f), new Vec2(3.0f, 4.0f), new MockPoolBall(3.0f, 3.0f)));

		assertTrue("The path is clear", shotGen.ballNotOnPath(new Vec2(3.0f,
				4.0f), new Vec2(1.0f, 3.0f), new MockPoolBall(3.0f, 3.0f)));

		// Clear Path
		assertTrue("The path is clear", shotGen.ballNotOnPath(new Vec2(3.0f,
				1.0f), new Vec2(1.0f, 3.0f), new MockPoolBall(3.0f, 3.0f)));
		// not clear Path
		assertTrue("The path is clear", shotGen.ballNotOnPath(new Vec2(1.0f,
				3.0f), new Vec2(3.0f, 4.0f), new MockPoolBall(3.0f, 3.0f)));
		...
		assertFalse("The path isn't clear(Just inside Ball)",
				shotGen.ballNotOnPath(new Vec2(4.0f, 2.950f), new Vec2(1.0f,
						2.950f), new MockPoolBall(3.0f, 3.0f)));
		// On Line
		assertFalse("The path isn't clear(Just touching Ball)",
				shotGen.ballNotOnPath(new Vec2(4.0f, 2.946f), new Vec2(1.0f,
						2.946f), new MockPoolBall(3.0f, 3.0f)));
		// just outside
		assertTrue("The path isn't clear(Just outside Ball)",
				shotGen.ballNotOnPath(new Vec2(4.0f, 2.940f), new Vec2(1.0f,
						2.940f), new MockPoolBall(3.0f, 3.0f)));

		// On an angle
		// Just inside
		assertFalse("The path isn't clear(Just inside Ball angled)",
				shotGen.ballNotOnPath(new Vec2(2.985f, 2.985f), new Vec2(3.0f,
						2.0f), new MockPoolBall(3.0f, 3.0f)));
		// On Line
		assertFalse("The path isn't clear(Just inside Ball angled)",
				shotGen.ballNotOnPath(new Vec2(2.980f, 2.980f), new Vec2(3.0f,
						2.0f), new MockPoolBall(3.0f, 3.0f)));
		// just outside
		assertFalse("The path isn't clear(Just inside Ball angled)",
				shotGen.ballNotOnPath(new Vec2(2.975f, 2.975f), new Vec2(3.0f,
						2.0f), new MockPoolBall(3.0f, 3.0f)));
		// just outside
